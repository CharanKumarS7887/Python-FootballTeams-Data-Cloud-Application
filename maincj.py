...
def csvu(cc):
    ...
    df.to_csv(file_path,index=False,header=['County','LeagueName','TeamName','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','GoalsScored','GoalsConceded','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','WLD','NextDate'])
    

    email_user = 'charanyesemailtt@gmail.com'
    email_password = 'Chiru@7887...'
    email_send = 'charanyesemail@gmail.com'
    ...
    attachment  = open('scrapedfile.csv','rb')
